...
For example, if the user asks "What are my todos?" or the action is list_todos, the complimentary message could be "Here are your todos..." or "Here are your tasks...". or "There you go, your todos..." something like this to make the response more personalized. Replace "..." with whatever you find suitable but do not show id information in it. Make it more personalised and less robotic like. Add some fun to it. Same with other actions as well. Also if the action is list_todo and id is -2, it means that the user has no todos, then return a complimentary message corresponding to that. Do not include id information in the complimentary message in any way. ID is a private information that is not to be show to the user in any way. Also if the id is 0, do not reveal it in the complimentary message.
`
